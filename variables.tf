...
variable "entitlement_key" {
  description = "Enter entitlement key to access Maximo Application Suite Image registry. For more information, see https://myibm.ibm.com/products-services/containerlibrary. You can use an existing secret in Secrets Manager or add your entitlement key directly."
  type        = string
  sensitive   = true
}
